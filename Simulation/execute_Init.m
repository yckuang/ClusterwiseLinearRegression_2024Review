...
InitType = {'random', 'kmean', 'tensor-sedghi2016', 'kmean1', 'incr'};
ScaleEsWeight = {'', 'huber', 'tukey', 'welsch', 'cauchy', 't-robust'};
RegrWeight = {'', 'huber', 'tukey', 'welsch', 'cauchy', 't-robust'};
DistrType = {'normal', 't'};

%N range
SamplSz_Grp = 2000%[100, 500, 1000, 2000];    % sample size per 
NZDR        = 1%[1.0:-0.2:0.4];
DOTPROD     = [0,0.5]%[0:0.2:0.8];      % dot products of beta
...
for RegrMethodNum = 1 : 1 % ls larsen pls
    for InitTypeNum = 1 : 3 % 'random', 'kmean', 'tensor-sedghi2016', 'kmean1', 'incr'
        for ScaleEsWeightNum = 3:3 % '', 'huber', 'tukey', 'welsch', 'cauchy', 't-robust'
            for RegrWeightNum = 1:1     % '', 'huber', 'tukey', 'welsch', 'cauchy', 't-robust';
