...
for RegrMethodNum = 1 : 1 % ls larsen pls
    for InitTypeNum = 1 : 1 % 'random', 'kmean', 'kmean1', 'incr01', 'tensor-sedghi2016'
        for ScaleEsWeightNum = 1:1 % '', 'huber', 'tukey', 'welsch', 'cauchy', 't-robust'
