...
InitType = {'random', 'kmean', 'kmean1', 'incr', 'tensor-sedghi2016'};
...
for RegrMethodNum = 1 : 2 % ls larsen pls
    for InitTypeNum = 2 : 2 % 'random', 'kmean', 'kmean1', 'incr', 'tensor-sedghi2016'
